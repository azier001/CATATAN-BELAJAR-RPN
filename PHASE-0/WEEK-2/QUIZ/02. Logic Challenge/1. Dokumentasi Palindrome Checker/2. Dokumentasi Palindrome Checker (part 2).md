# 📚 Dokumentasi Lengkap: Palindrome Checker - Part 2
...
- **<a href="https://github.com/azier001/CATATAN-BELAJAR-RPN/blob/main/PHASE-0/WEEK-2/QUIZ/02.%20Logic%20Challenge/1.%20Dokumentasi%20Palindrome%20Checker/1.%20Dokumentasi%20Palindrome%20Checker%20(part%201).md" target="_blank">← Kembali ke Part 1</a>** - Pengenalan & Debugging
- **Part 2 (Dokumen Ini)** - Solusi 1 & 2
- **<a href="https://github.com/azier001/CATATAN-BELAJAR-RPN/blob/main/PHASE-0/WEEK-2/QUIZ/02.%20Logic%20Challenge/1.%20Dokumentasi%20Palindrome%20Checker/3.%20Dokumentasi%20Palindrome%20Checker%20(part%203).md" target="_blank">Lanjut ke Part 3 →</a>** - Solusi 3 & 4 + Best Practices
---

## 📑 Daftar Isi Part 2

- [💡 Solusi Alternatif 1: For Loop - Versi Original](#solusi-1)
  - [📝 Ringkasan Algoritma](#solusi-1-algoritma)
  - [💻 Implementasi Code](#solusi-1-code)
  - [🔍 Cara Kerja](#solusi-1-cara-kerja)
  - [⚡ Kompleksitas](#solusi-1-kompleksitas)
  - [⚖️ Kelebihan & Kekurangan](#solusi-1-pros-cons)

- [💡 Solusi Alternatif 2: String Reversal Method](#solusi-2)
  - [📝 Ringkasan Algoritma](#solusi-2-algoritma)
  - [💻 Implementasi Code](#solusi-2-code)
  - [🔍 Cara Kerja](#solusi-2-cara-kerja)
  - [⚡ Kompleksitas](#solusi-2-kompleksitas)
  - [⚖️ Kelebihan & Kekurangan](#solusi-2-pros-cons)
...
Loop 1: kata[0] vs kata[4] → 'k' vs 'k' ✅
Loop 2: kata[1] vs kata[3] → 'a' vs 'a' ✅
Loop 3: kata[2] tidak perlu dicek (tengah) ⏭️
Result: true ✅
```
...
Loop 1 (i = 0):
  kata[0] = 'k'
  kata[5 - 1 - 0] = kata[4] = 'k'
  'k' !== 'k' ? false → Lanjut loop

Loop 2 (i = 1):
  kata[1] = 'a'
  kata[5 - 1 - 1] = kata[3] = 'a'
  'a' !== 'a' ? false → Lanjut loop

Loop selesai → return true ✅
```

#### 📌 Example 2: `palindrome('blanket')`
...
Loop 1 (i = 0):
  kata[0] = 'c'
  kata[5 - 1 - 0] = kata[4] = 'c'
  'c' !== 'c' ? false → Lanjut loop

Loop 2 (i = 1):
  kata[1] = 'i'
  kata[5 - 1 - 1] = kata[3] = 'i'
  'i' !== 'i' ? false → Lanjut loop
...
- Contoh: `'abc'` → langsung return `false`

**Worst Case:** `O(n)`
- Jika harus cek semua karakter hingga tengah
- Contoh: `'katak'` → cek semua hingga selesai
...
1. **Efisien dalam penggunaan memory** 💾
   - Space complexity: O(1)
   - Tidak membuat copy string

2. **Fast untuk non-palindrome** ⚡
...
## 🎯 Kapan Menggunakan Solusi 1?

**Gunakan solusi ini jika:**
- ✅ Memory efficiency adalah prioritas utama
- ✅ Dealing dengan string yang sangat panjang
- ✅ Perlu performance terbaik untuk non-palindrome
- ✅ Interview coding yang fokus pada space complexity

**Hindari solusi ini jika:**
- ❌ Prioritas adalah code readability
- ❌ Team lebih prefer simple & clean code
- ❌ String input relatif pendek (< 1000 char)
...
**Kompleksitas:**
- ⏱️ Time: `O(n)` (split + reverse + join + compare)
- 💾 Space: `O(n)` (membuat array dan string baru)
...
2. **Slower untuk very long strings** 🐌
   - Multiple operations: split, reverse, join
   - Overhead dari method calls

3. **Tidak efficient untuk large-scale** 📊
...
## 🎯 Kapan Menggunakan Solusi 2?

**Gunakan solusi ini jika:**
- ✅ Code readability adalah prioritas
- ✅ String input relatif pendek
- ✅ Rapid prototyping atau quick implementation
- ✅ Teaching/learning context
- ✅ Code review oleh team yang prefer simple code

**Hindari solusi ini jika:**
- ❌ Dealing dengan very large strings (> 10,000 chars)
- ❌ Memory adalah constraint
...
| **Speed (non-palindrome)** | 🟢 Fast (early exit) | 🟡 Must process all |
| **Code Length** | 🟡 ~6 lines | 🟢 ~2 lines |
| **Maintainability** | 🟡 Medium | 🟢 Easy |
| **Beginner Friendly** | 🟡 Medium | 🟢 Very friendly |
| **Interview** | 🟢 Shows algo skill | 🟢 Shows JS knowledge |
| **Large Scale** | 🟢 Better | 🟡 Acceptable |
...
- ✅ Solusi 1: For Loop approach dengan early exit
- ✅ Solusi 2: String Reversal dengan built-in methods
- ✅ Detail cara kerja masing-masing solusi
- ✅ Kompleksitas time & space
- ✅ Kelebihan & kekurangan setiap approach
- ✅ Kapan menggunakan solusi mana
...
- 📝 Naming Convention (Indonesia vs English)
- 📊 Perbandingan lengkap 4 solusi
- 🎓 Key Takeaways
- 💪 Latihan tambahan
- 📚 Referensi & resources

**Get ready untuk level up!** 🚀

---

> 💡 **Pro Tip:** Coba implementasikan kedua solusi ini sendiri tanpa melihat code! Gunakan ringkasan algoritma sebagai guide. Ini akan meningkatkan pemahaman dan muscle memory kamu dalam coding!
